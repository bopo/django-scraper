# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-28 21:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraper.ScrapedObjClass')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scraped_obj_attr', models.ForeignKey(help_text='The different attributes to be scraped, exactly one attribute of type BASE necessary.', on_delete=django.db.models.deletion.CASCADE, to='scraper.ScrapedObjAttr')),
        ...
        migrations.AddField(
            ...
            name='obj_class',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraper.ScrapedObjClass'),
        ),
        migrations.AddField(
            model_name='requestpagetype',
            name='scraped_obj_attr',
            field=models.ForeignKey(blank=True, help_text='Empty for main page, attribute of type DETAIL_PAGE_URL scraped from main page for detail pages.', null=True, on_delete=django.db.models.deletion.CASCADE, to='scraper.ScrapedObjAttr'),
        ),
        migrations.AddField(
            model_name='requestpagetype',
            name='scraper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scraper.Scraper'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='checker',
            name='scraped_obj_attr',
            field=models.ForeignKey(help_text='Attribute of type DETAIL_PAGE_URL, several checkers for same DETAIL_PAGE_URL attribute possible.', on_delete=django.db.models.deletion.CASCADE, to='scraper.ScrapedObjAttr'),
        ),
        migrations.AddField(
            model_name='checker',
            name='scraper',
